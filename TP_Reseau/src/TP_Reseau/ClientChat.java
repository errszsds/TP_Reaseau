...
public class ClientChat extends Application{
	...
	public void start(Stage primaryStage) throws Exception {
		...
		BorderPane borderPane=new BorderPane(); //element conteneur (possède 5 parties N S E O C)
		...
		ObservableList<String> listModel=FXCollections.observableArrayList(); //listModel où se trouve les données
